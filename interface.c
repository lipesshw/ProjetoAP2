...
do
{
    ...
    do
    {
        ...
        {
            printf("\n");
            printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t    O preço do produto deve ser um número válido e não negativo.        \n"VERDE);
            printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                        Tente novamente...              \n"VERDE );
            printf("\n");
            sleep(2);
    ...
    do
    {
        ...
        {
            printf("\n");
            printf(VERMELHO"\t\t\t\t\t\t\t\t\t     A quantidade do produto deve ser um número inteiro válido e não negativo.        \n"VERDE);
            printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                        Tente novamente...              \n"VERDE );
            printf("\n");
            sleep(2);
            while (getchar() != '\n'); // Limpar o buffer do teclado
...
void criarNovaVenda(FILE *arquivo)
{
    ...
    {
        printf("\n");
        printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                  O Produto não foi encontrado.        \n"VERDE);
        printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                         Tente novamente!        \n"VERDE);
        printf("\n");
        printf("\t\t\t\t\t\t\t\t\t\t\t   > Digite o ID do produto a ser vendido: ");
        scanf("%d", &id);
    ...
    while(fread(&produto, sizeof(Produto), 1, arquivo))
    {
        ...
        printf("\t\t\t\t\t\t\t\t\t\t\t    > Digite a quantidade a ser vendida: ");
            ...
            {
                printf("\n");
                printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                Quantidade inválida de produtos.        \n"VERDE);
                printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                         Tente novamente!        \n"VERDE);
                printf("\n");
            ...
            {
                printf("\n");
                printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                 Quantidade insuficiente em estoque.        \n"VERDE);
                printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t                         Tente novamente!        \n"VERDE);
                printf("\n");
                printf("\t\t\t\t\t\t\t\t\t\t\t    > Digite a quantidade a ser vendido: ");
                scanf("%d", &quantidadeVendida);
...
void adicionarEstoque(FILE *arquivo)
{
    ...
    while (id < 0)
    {
            printf(VERMELHO"\t\t\t\t\t\t\t\t\t\t\t      ID %d inválido. Tente novamente!\n",id);
            printf(VERDE"\t\t\t\t\t\t\t\t\t\t\t> Digite o ID do produto para adicionar estoque: ");
        scanf("%d", &id);
    }
